...
<head>
    ...
    <title>Manage Project: <?php echo htmlspecialchars($project['project_name']); ?> - <?php echo APP_NAME; ?></title>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    <div class="flex items-center">
                        <a href="projects.php" class="flex items-center">
                            <i class="fas fa-arrow-left text-blue-600 dark:text-blue-400 text-xl mr-3"></i>
                            <h1 class="text-lg font-semibold text-gray-900 dark:text-white">Manage Project</h1>
                        </a>
                    </div>
                    <div class="flex items-center space-x-4">
                        ...
                        <a href="../logout.php" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
                ...
                <div class="p-6">
                    <div class="flex justify-between items-start mb-4">
                        ...
                        <div class="flex space-x-2">
                            ...
                            <button onclick="deleteProject()" class="inline-flex items-center px-3 py-2 border border-red-600 text-sm font-medium rounded-md text-red-600 hover:bg-red-50 dark:hover:bg-red-900 transition-colors">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        ...
                        <div>
                            ...
                            <dd class="text-sm text-gray-900 dark:text-white"><?php echo format_currency($project['budget']); ?></dd>
                        </div>
                        <div>
