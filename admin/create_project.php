...
<head>
    ...
    <title>Create New Project - <?php echo APP_NAME; ?></title>
                ...
                <div class="flex justify-between h-16">
                    <div class="flex items-center">
                        <a href="../admin.php" class="flex items-center">
                            ...
                            <h1 class="text-lg font-semibold text-gray-900 dark:text-white">Create New Project</h1>
                        </a>
                    </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-8">
                            ...
                            <div class="flex items-center" id="step3-indicator">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Financial & Timeline</p>
                                </div>
                            </div>
                ...
                <form id="projectForm" method="POST" action="submit_project.php">
                    ...
                    <div id="step3" class="step-content p-6 hidden">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-6">Financial & Timeline Information</h3>
                        <div class="space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
