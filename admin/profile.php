...
require_admin(); // All roles can manage their own profile
...
<div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 mt-6">
    <div class="p-6 border-b border-gray-200 dark:border-gray-700">
        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Administrator Management</h3>
        <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Manage system administrators and their roles</p>
    </div>
    <div class="p-6">
        <a href="manage_admins.php" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 transition-colors">
