...
function handle_project_creation($data) {
    ...
    try {
        ...
        $required_fields = ['project_name', 'department_id', 'project_year', 'county_id', 'sub_county_id', 'ward_id', 'budget'];
        ...
        $sql = "INSERT INTO projects (
                    ...
                    budget, allocated_budget, spent_budget, contractor_name, contractor_contact,
                    start_date, expected_completion_date, status, step_status, progress_percentage,
                    total_steps, completed_steps, created_by
                ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        $params = [
            ...
            floatval(str_replace(',', '', $data['budget'])),
            floatval(str_replace(',', '', $data['allocated_budget'] ?? 0)),
            floatval(str_replace(',', '', $data['spent_budget'] ?? 0)),
