                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-blue-700 dark:text-blue-300">
                            <ul class="list-disc pl-5 space-y-1">
                                ...
                                <li>Required columns: project_name, department, ward, sub_county, county, budget, year</li>
                        ...
                        <table class="min-w-full text-sm">
                            <thead class="bg-gray-50 dark:bg-gray-700">
                                <tr>
                                    ...
                                    <th class="px-3 py-2 text-left font-medium text-gray-900 dark:text-white">budget</th>
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                <tr>
                                    ...
                                    <td class="px-3 py-2 text-gray-600 dark:text-gray-300">50000000</td>
