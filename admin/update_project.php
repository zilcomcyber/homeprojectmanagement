...
try {
    ...
    $sql = "UPDATE projects SET 
                ...
                location_coordinates = ?, budget = ?, allocated_budget = ?, spent_budget = ?,
                contractor_name = ?, contractor_contact = ?, start_date = ?, 
                expected_completion_date = ?, status = ?, updated_at = NOW()
            WHERE id = ?";
    ...
    $params = [
        ...
        floatval(str_replace(',', '', $_POST['allocated_budget'] ?? 0)),
        floatval(str_replace(',', '', $_POST['spent_budget'] ?? 0)),
