...
function mark_as_spam($feedback_id) {
    ...
    try {
        ...
        return ['success' => false, 'message' => 'Error marking as spam'];
    }
}
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Manage citizen feedback and comments</p>
        </div>
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div class="quick-actions flex items-center space-x-2 mt-3">
                                    ...
                                    <button onclick="quickAction('spam', <?php echo $comment['id']; ?>)" 
