            ...
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 px-4 py-4 space-y-2 overflow-y-auto sidebar-scrollbar">
                    ...
                    <?php if ($current_admin['role'] !== 'viewer'): ?>
                        ...
                        <a href="admin/feedback.php" class="text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 group flex items-center px-3 py-2 text-sm font-medium rounded-l-md transition-colors">
