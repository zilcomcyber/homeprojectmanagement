                ...
                <?php foreach ($ongoing_projects as $index => $project): ?>
                    <div class="project-card-modern fade-in-up" style="--stagger-delay: <?php echo $index * 0.1; ?>s">
                        ...
                        <?php if (!empty($project['location_coordinates'])): ?>
                            <div class="h-32 bg-gray-200 relative cursor-pointer" onclick="window.location.href='<?php echo BASE_URL; ?>project_details/<?php echo $project['id']; ?>'">
                        ...
                        <?php else: ?>
                            <div class="h-32 bg-gray-200 flex items-center justify-center cursor-pointer" onclick="window.location.href='<?php echo BASE_URL; ?>project_details/<?php echo $project['id']; ?>'">
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex gap-2 mt-4">
                                <a href="<?php echo BASE_URL; ?>project_details/<?php echo $project['id']; ?>" 
        ...
        <div class="mb-6">
            ...
            <div class="space-y-3">
                <?php foreach ($ongoing_projects as $project): ?>
                    <div class="bg-white rounded-lg p-4 border border-gray-200 hover:shadow-md transition-shadow cursor-pointer" onclick="window.location.href='<?php echo BASE_URL; ?>project_details/<?php echo $project['id']; ?>'">
                        <div class="space-y-2">
