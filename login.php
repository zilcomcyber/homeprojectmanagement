...
<body class="h-full bg-gray-50 dark:bg-gray-900">
        ...
        <div class="max-w-md w-full space-y-8">
            ...
            <form class="mt-8 space-y-6" method="POST">
                ...
                <div class="text-center">
                    <a href="index.php" class="text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300 text-sm transition-colors">
    ...
    <div class="fixed top-4 right-4">
        <button id="theme-toggle" class="p-2 rounded-lg bg-white dark:bg-gray-800 shadow-lg text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
