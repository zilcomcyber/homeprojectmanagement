...
<div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow">
    ...
    <?php if (!empty($project['location_coordinates'])): ?>
        <div class="h-32 bg-gray-200 relative cursor-pointer" onclick="window.location.href='project_details.php?id=<?php echo $project['id']; ?>'">
    ...
    <?php else: ?>
        <div class="h-32 bg-gray-200 flex items-center justify-center cursor-pointer" onclick="window.location.href='project_details.php?id=<?php echo $project['id']; ?>'">
    ...
    <div class="p-6">
        ...
        <div class="flex items-start justify-between mb-4">
            <div class="flex-1">
                <a href="project_details.php?id=<?php echo $project['id']; ?>" class="block hover:text-blue-600 transition-colors">
...
<!-- Project List Item - Clean Design -->
<div class="bg-white rounded-lg p-4 border border-gray-200 hover:shadow-md transition-shadow cursor-pointer" onclick="window.location.href='project_details.php?id=<?php echo $project['id']; ?>'">
    <!-- Main Content -->
    <div class="space-y-3">
        <!-- Title and Location -->
        <div>
