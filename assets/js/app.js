                ...
                const popupContent = `
                    <div class="relative p-3 max-w-xs">
                        ...
                        <div class="flex gap-2">
                            <a href="${window.BASE_URL}project_details/${project.id}"
                        ...
                        ${projects.map((project, index) => `
                            <div class="flex items-center justify-between p-4 hover:bg-gray-50 transition-colors">
                                <div class="flex-1 min-w-0">
                                    <div class="mb-2">
                                        <a href="${window.BASE_URL}project_details/${project.id}" class="font-semibold hover:text-blue-600 transition-colors line-clamp-1" style="color: #000000 !important;">
                                            ${project.project_name}
                                        </a>
                                    </div>
                                ...
                                <div class="flex items-center gap-3 ml-4">
                                    <a href="${window.BASE_URL}project_details/${project.id}" class="text-blue-600 hover:text-blue-800 font-medium text-sm whitespace-nowrap">
                                        View Details →
                                    </a>
                                </div>
                            </div>
