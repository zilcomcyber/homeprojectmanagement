...
class MapManager {
    ...
    addProjectMarker(project) {
        try {
            ...
            // Create custom icon with darker colors and no white rings
            const statusColors = {
                'planning': '#92400e',     // Very Dark Amber
                'ongoing': '#1e3a8a',      // Very Dark Blue
                'completed': '#064e3b',    // Very Dark Green
                'suspended': '#c2410c',    // Very Dark Orange
